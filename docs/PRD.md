...
| 状态     | 产品定义草案                                          |
| 更新日期 | 2026-07-22                                            |
| 当前阶段 | M9 已基本通过；M11 已验收；M10 OCR 技术验证有条件通过 |
...
M5 已落地 BOOK-001～BOOK-003、BOOK-007，以及 BOOK-008 中的个人解析和多区域来源。框选坐标按 `coordinate_version=1` 保存为 PDF 页面归一化矩形；OCR、AI 检测、答案区域语义、批注和附件仍保留在后续批次。
