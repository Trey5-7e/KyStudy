...
use crate::application::{
    ...
    BackupReport, BatchClassifyQuestionsInput, BeginResourceIndexInput, BulkQuestionAttemptInput,
...
use crate::domain::{
    ...
    QuestionKnowledgeLink, QuestionRegion, QuestionType, ResourceIndexSession, ResourceIndexStatus,
    ResourceSearchResult, ReviewBacklog, ReviewDashboard, ReviewEvent, ReviewMastery,
    ReviewPreferences, ReviewQuestion, ReviewRating, ReviewReason, ReviewScheme,
